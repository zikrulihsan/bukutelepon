  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40">
      <div className="mx-auto max-w-[425px]">
        <div className="rounded-t-[14px] border-t border-gray-100 bg-white shadow-[0_-4px_15px_rgba(8,35,75,0.09)]">
          <div className="grid min-h-[68px] grid-cols-5 pb-[env(safe-area-inset-bottom)] pt-1.5">
            <button
              onClick={() => {
                if (location.pathname === "/") window.dispatchEvent(new Event("reset-home"));
                else navigate("/");
              }}
              className={itemClass}
            >
            ...
            <button onClick={() => navigate("/search")} className={itemClass}>
            ...
            <button onClick={() => navigate("/saved")} className={itemClass}>
              {active("/saved") ? (
            ...
            <button onClick={() => navigate("/submit")} className={itemClass}>
              {active("/submit") ? (
            ...
            <button onClick={() => navigate("/account")} className={itemClass}>
              {active("/account") ? (
