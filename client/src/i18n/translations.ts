...
const id = {
  ...
  "home.loadingMessage": "Mencarikan kontak penting di sekitarmu…",
  "home.searchPlaceholder": "Cari kontak…",
  "home.heroTitleFirst": "Cari kebutuhanmu",
  "home.heroTitleAccent": "di {city}",
  ...
  "home.view": "Lihat",
  "home.whatsInCity": "Temukan di {city}",
  "home.discoveryCoffeeTitle": "Tempat ngopi",
  "home.discoveryCoffeeDescription": "Temukan kopi lokal dan tempat santai pilihan.",
  "home.discoverySouvenirTitle": "Oleh-oleh khas",
  "home.discoverySouvenirDescription": "Bawa pulang rasa khas kota ini.",
  "home.discoveryTravelTitle": "Travel & rental",
  ...
  "search.loadingHint": "Mencarikan kontak yang pas di sekitarmu…",
  "search.partialOffline": "Sedang offline. Hasil ini berasal dari cache yang belum selesai disinkronkan.",
  ...
  "admin.heroPromotions": "Promo Hero",
  ...
  "admin.searchContacts": "Cari nama, nomor, kota, atau kategori...",
  "admin.clearSearch": "Hapus pencarian",
  "admin.noContactsFound": "Tidak ada kontak yang cocok.",
  ...
  "admin.descriptionEn": "Deskripsi (Bahasa Inggris)",
  "admin.descriptionEnPlaceholder": "Deskripsi singkat dalam bahasa Inggris...",
  "admin.heroPromoHeading": "Kelola Promo Hero",
  "admin.heroPromoIntro": "Atur gambar, pesan, tautan, dan urutan promo pada hero beranda.",
  "admin.heroPromoAdd": "Tambah promo",
  "admin.heroPromoEdit": "Edit promo",
  "admin.heroPromoEmpty": "Belum ada promo hero.",
  "admin.heroPromoTitle": "Judul",
  "admin.heroPromoHighlight": "Teks aksen",
  "admin.heroPromoDescription": "Deskripsi",
  "admin.heroPromoEnglish": "Versi Bahasa Inggris (opsional)",
  "admin.heroPromoImage": "Gambar latar",
  ...
  "admin.heroPromoMoveDown": "Turunkan",
  "admin.heroPromoDelete": "Hapus",
  "admin.heroPromoDeleteConfirm": "Hapus promo ini? Gambar yang diunggah juga akan dihapus.",
  "admin.heroPromoSaved": "Promo berhasil disimpan.",
  "admin.heroPromoDeleted": "Promo berhasil dihapus.",
  "admin.heroPromoError": "Promo gagal diproses. Periksa kembali data yang diisi.",
...
const en: Record<TranslationKey, string> = {
  ...
  "home.loadingMessage": "Finding useful contacts around you…",
  "home.searchPlaceholder": "Search contacts…",
  "home.heroTitleFirst": "Find what you need",
  "home.heroTitleAccent": "in {city}",
  ...
  "home.seeAll": "See all",
  "home.view": "View",
  "home.whatsInCity": "Discover in {city}",
  "home.discoveryCoffeeTitle": "Coffee spots",
  "home.discoveryCoffeeDescription": "Discover local coffee and relaxing spots.",
  "home.discoverySouvenirTitle": "Local souvenirs",
  "home.discoverySouvenirDescription": "Bring home the flavors of this city.",
  "home.discoveryTravelTitle": "Travel & rentals",
  ...
  "search.loadingHint": "Finding the right contacts around you…",
  "search.partialOffline": "You are offline. These results come from a cache that has not finished syncing.",
  "search.share": "Share",
  ...
  "admin.users": "Users",
  "admin.heroPromotions": "Hero Promotions",
  ...
  "admin.searchContacts": "Search by name, phone, city, or category...",
  "admin.clearSearch": "Clear search",
  "admin.noContactsFound": "No matching contacts found.",
  ...
  "admin.descriptionEnPlaceholder": "A short description in English...",
  "admin.heroPromoHeading": "Manage Hero Promotions",
  "admin.heroPromoIntro": "Manage the images, messages, links, and order of homepage hero promotions.",
  "admin.heroPromoAdd": "Add promotion",
  "admin.heroPromoEdit": "Edit promotion",
  "admin.heroPromoEmpty": "There are no hero promotions yet.",
  "admin.heroPromoTitle": "Title",
  "admin.heroPromoHighlight": "Accent text",
  "admin.heroPromoDescription": "Description",
  "admin.heroPromoEnglish": "English version (optional)",
  "admin.heroPromoImage": "Background image",
  ...
  "admin.heroPromoMoveDown": "Move down",
  "admin.heroPromoDelete": "Delete",
  "admin.heroPromoDeleteConfirm": "Delete this promotion? Its uploaded image will also be removed.",
  "admin.heroPromoSaved": "Promotion saved.",
  "admin.heroPromoDeleted": "Promotion deleted.",
  "admin.heroPromoError": "The promotion could not be processed. Check the submitted data.",
